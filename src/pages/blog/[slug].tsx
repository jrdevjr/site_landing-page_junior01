...
export default function PostPage() {
    ...
    const slug = router.query.slug as string;
     if (!slug) {
    return <p className="mt-32 text-gray-100 text-center">Carregando...</p>;
  }
   ...
   if (!post) {
    return <p className="mt-32 text-gray-100 text-center">Post não encontrado</p>;
  }
    ...
    return (
        <main className="mt-32 text-gray-100">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr-300px] gap-6 lg:gap-12">
